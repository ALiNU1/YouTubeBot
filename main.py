...
async def help(msg:types.Message):
    inline_kb = [
        ...
        [InlineKeyboardButton("Ссылка", url = "https://www.youtube.com/ watch?v=ygTZZpVkmKg&list=RDygTZZpVkmKg&start_radio=1")],
    ]
...
async def all(call):
    ...
    if call.data == "video":
        print("video")
        await call.message.answer(f"Отправьте ссылку и я вам его скачаю")
        await DownloadVideo.download.set()
